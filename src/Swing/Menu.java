...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(700, 348));
        setResizable(false);
        setSize(new java.awt.Dimension(700, 348));
    ...
    private void ipFocusGained(java.awt.event.FocusEvent evt) {
        if(ip.getText().equals("IP")) {
            ip.setText("");
        }
    }

    private void ipFocusLost(java.awt.event.FocusEvent evt) {
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {
        if (!(username.getText().isEmpty() || ip.getText().isEmpty()) && !(username.getText().isEmpty() || ip.getText().equals("IP"))) {
            ...
            Software software = new Software(User,IPadress);
            software.setVisible(true);
        }
        else{
            showMessageDialog(null, "Fill the blanks.");
